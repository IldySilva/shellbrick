...
class _AppShellState extends State<AppShell> with WindowListener {
  ...
  Future<void> _handleConnect(SshHost host) async {
    ...
    // Check secure storage first — skip prompt if credential already saved.
    ...
    try {
      ...
      // Persist credential only after a proven successful connection.
      ...
      if (mounted) setState(() => _selectedIndex = 1); // go to Terminal tab
